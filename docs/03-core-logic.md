...
| Model                                                                   | Method                                                                                                                                          |
| ----------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| Anthropic (`anthropic-direct:…` or a Bedrock id containing `anthropic`) | Exact via Anthropic SDK `beta.messages.countTokens` (SSM key `/transcripta/anthropic-api-key`). Missing key or API failure → character estimate |
