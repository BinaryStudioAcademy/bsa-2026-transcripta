...
function Dropzone({
  ...
  }, file), /*#__PURE__*/React.createElement("small", null, "Ready to upload")) : state === 'rejected' ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("b", null, reason || 'That file can’t be read'), /*#__PURE__*/React.createElement("small", null, "PDFs and image archives \xB7 up to 500 MB, up to 500 pages"), /*#__PURE__*/React.createElement("button", {
    className: "tx-btn tx-btn--secondary tx-btn--sm",
    onClick: onChoose,
    style: {
      marginTop: 6
